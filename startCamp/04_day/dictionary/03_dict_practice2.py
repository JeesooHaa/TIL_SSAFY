...
pro-gj
"""
for man in ssafy['classes']['gj'].values():
    print(man)
...
for ky, value in ssafy['language']['python']['frameworks'].items():
    print(f'{ky}는 {value}이다')
...
bad = random.choice(ssafy['classes']['dj']['groups']['E'])
print(f'오늘의 당번은 {bad}')

# print(f"오늘의 당번은 {ssafy['classes']['dj']['groups']['E'][0]}") 밖에 더블로 할것 / 아니면 오류남 
# print(f'{average_temp:.1f}') 소수점은 요래 출력 
